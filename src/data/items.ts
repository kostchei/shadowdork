...
const ITEM_LIST: readonly ItemDef[] = [
  ...
  // Potions & Consumables
  { id: "potion-healing", name: "Potion of Healing", slotCost: 1, bundleSize: 1, tags: ["potion", "magic"], valueGp: 75, description: "Restore 1d6 HP to a living or dying party member.", use: { actions: ["consume", "inspect"], target: "ally" } },
  { id: "potion-invisibility", name: "Potion of Invisibility", slotCost: 1, bundleSize: 1, tags: ["potion", "magic"], description: "Become invisible for 5 rounds; attacking or casting ends it.", use: { actions: ["consume", "inspect"], target: "self" } },
  { id: "potion-water-breathing", name: "Potion of Water Breathing", slotCost: 1, bundleSize: 1, tags: ["potion", "magic"], description: "Breathe underwater for 20 rounds.", use: { actions: ["consume", "inspect"], target: "self" } },
  { id: "potion-flying", name: "Potion of Flying", slotCost: 1, bundleSize: 1, tags: ["potion", "magic"], description: "Fly with the normal movement controls for 5 rounds.", use: { actions: ["consume", "inspect"], target: "self" } },
  { id: "potion-giant-strength", name: "Potion of Giant Strength", slotCost: 1, bundleSize: 1, tags: ["potion", "magic"], description: "Your Strength becomes at least 18 for 5 rounds.", use: { actions: ["consume", "inspect"], target: "self" } },
  ...
  // Spell Scrolls
  { id: "scroll-cure-wounds", name: "Scroll of Cure Wounds", slotCost: 1, bundleSize: 1, tags: ["scroll", "magic"], use: { actions: ["cast", "inspect"], target: "none" } },
  { id: "scroll-light", name: "Scroll of Light", slotCost: 1, bundleSize: 1, tags: ["scroll", "magic"], use: { actions: ["cast", "inspect"], target: "none" } },
  { id: "scroll-burning-hands", name: "Scroll of Burning Hands", slotCost: 1, bundleSize: 1, tags: ["scroll", "magic"], use: { actions: ["cast", "inspect"], target: "none" } },
  { id: "scroll-feather-fall", name: "Scroll of Feather Fall", slotCost: 1, bundleSize: 1, tags: ["scroll", "magic"], use: { actions: ["cast", "inspect"], target: "none" } },
  { id: "scroll-covenant", name: "Scroll of the Covenant", slotCost: 1, bundleSize: 1, tags: ["scroll", "magic"] },

  // Wands, Rings & Utility Items
  { id: "wand-fireball", name: "Wand of Fireballs", slotCost: 1, bundleSize: 1, tags: ["wand", "magic"], use: { actions: ["cast", "inspect"], target: "none", charges: 1, rechargeOnRest: true, inertOnFail: true, breaksOnCriticalFail: true } },
  { id: "ring-feather-falling", name: "Ring of Feather Falling", slotCost: 1, bundleSize: 1, tags: ["ring", "magic"], description: "Automatically prevents one dangerous fall, then recharges on rest.", use: { actions: ["activate", "inspect"], target: "self", charges: 1, rechargeOnRest: true } },
  { id: "egg-of-cockatrice", name: "Egg of the Cockatrice", slotCost: 0, bundleSize: 1, tags: ["relic", "magic"] },
  { id: "bag-of-holding", name: "Bag of Holding", slotCost: 1, bundleSize: 1, tags: ["utility", "magic"], capacityBonus: 5, description: "Adds 5 gear slots while carried. It cannot be dropped while over capacity.", use: { actions: ["inspect"], target: "none" } },
